...
Имя: {req.name}
Профессия: {req.job}
Характер: {req.personality}
Тип отношений с пользователем: {req.relationship}
Национальность: {req.nationality}
...
- Профессия: {req.job}
- Характер: {req.personality}
- Тип отношений с игроком: {req.relationship}
- Предпочтения: {', '.join(req.preferences) if req.preferences else 'не указаны'}
...
- Характер: {req.personality}
- Профессия: {req.job}
- Тип отношений: {req.relationship}
- Предпочтения: {', '.join(req.preferences) if req.preferences else 'не указаны'}
