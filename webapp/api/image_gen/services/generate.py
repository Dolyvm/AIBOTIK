...
age_interval_by_age = {  # "18", "25", "35", "45", "70"
    "18": "18-20 years old",
    "25": "20-30 years old",
    "35": "30-40 years old",
    "45": "50 years old",
...
nsfw_level_to_prompt_real = [  # ", but/and/etc. ..." before these strings.
    "and she is fully covered in clothes",
    "seducing and teasing with her posture",
    "making accent on her beautiful ass and tits",
    "but she lowering it to show her naked tits",  # если clothes != nude
    "but she pulled her pants down to the floor to show her (naked tits) and (naked ass and shaved pussy)",  # если clothes != nude
    "showing her naked tits and beautiful naked ass",  # если clothes != nude
]
...
def build_prompt_from_character(
    ...
    if character["model_type"] == "real":
        ...
        if nsfw_level and outfit_key != "nude":
            ...
            nsfw_modificator = ""
        template = get_prompt("z_image_template")
        pos = template.format(
            **character["visual"],
        ...
        template = get_prompt("illustrious_template")
        neg = get_anime_base_negative()
        pos = template.format(
            **character["visual"],
            face_expression=face_expression,
            age_interval=age_interval_by_age[character["visual"]["age"]],
