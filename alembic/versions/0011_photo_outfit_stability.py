"""stabilize photo outfit prompt rules

Revision ID: 0011_photo_outfit_stability
Revises: 0010_compact_anime_prompts
...
revision: str = "0011_photo_outfit_stability"
down_revision: Union[str, None] = "0010_compact_anime_prompts"
...
PHOTO_PROMPTS = {
    "photo_scene_extractor": PHOTO_SCENE_EXTRACTOR,
    ...
    "photo_prompt_anime_female": "{setting}, {subject_tags}, {identity}, {body}, {clothing}, {expression}, {pose}, {scene_notes}, {style_tags}",
    "photo_prompt_anime_male": "{setting}, {subject_tags}, {identity}, {body}, {clothing}, {expression}, {pose}, {scene_notes}, {style_tags}",
    "photo_negative_anime_female": "multiple people, man, boy, bad anatomy, bad hands, extra fingers, low quality, text, watermark, logo",
    "photo_negative_anime_male": "woman, girl, multiple people, bad anatomy, bad hands, low quality, text, watermark, logo",
}
...
def upgrade() -> None:
    ...
    for key, content in PHOTO_PROMPTS.items():
        bind.execute(statement, {"key": key, "content": content})
